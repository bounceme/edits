...
hi MatchParen ctermfg=87 ctermbg=NONE cterm=underline guifg=#00ffff guibg=NONE gui=underline
...
hi IncSearch ctermfg=0 ctermbg=216 cterm=NONE guifg=#000000 guibg=#ff9e7b gui=NONE
